		...
		<div>
			...
			<table border="1">
				...
				<tr>
					...
					<td><a href="excluir.php?id=<?=$dados['id_cor']?>"  onclick='javascript: return confirm("TEM CERTEZA QUE DESEJA EXCLUIR ESTA COR? \sn\n NOTE QUE TODOS OS VEICULOS DESTA COR TAMBEM SERAO DELETADOS!")'>Excluir</a></td>
				</tr>
