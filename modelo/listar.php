		...
		<div>
			...
			<table border="1">
				...
				<tr>
					...
					<td>
						<a href="excluir.php?id=<?=$dados['id_modelo']?>" onclick='javascript: return confirm("TEM CERTEZA QUE DESEJA EXCLUIR ESTE MODELO? \sn\n NOTE QUE TODOS OS VEICULOS DESTE MODELO TAMBEM SERAO DELETADOS!")'>Excluir</a>
					</td>
				</tr>
